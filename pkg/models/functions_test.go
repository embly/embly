...
var (
	functionDBTypes = map[string]string{`ID`: `uuid`, `Name`: `character varying`, `Tag`: `character varying`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`}
	_               = bytes.MinRead
)
